...
def main():
    ...
    # resume_epoch = 37  # manually set for testing
    # model.load_state_dict(torch.load(os.path.join(saved_path, f"net_epoch{resume_epoch}.pth") , map_location='cpu'), strict=False)
    ...
    for bitwidth in [8, 4, 2]:
        ...
        # print(f"Testing with {channel} channels")
        # set_dynamic_conv_channel(model, channel)
        set_dynamic_bitwidth(model, bitwidth)
